...
const App = () => {
  ...
  const [orderId, setOrderId] = useState('paytm_1657798864428_5119');
  const [amount, setAmount] = useState('100');
  const [urlScheme, setURLScheme] = useState('');
  const [tranxToken, setTranxToken] = useState(
    'bfc952244e144629b3f95167301d4e191657798864452',
  );
            ...
            <View style={{margin: 16}}>
              ...
              >
                ...
                >
                  ...
                  >
                    isInvokeRestricted :{' '}
                    {appInvokeRestricted ? 'true' : 'false'}
                  </Text>
                </View>
                ...
                >
                  <Switch
                    ...
                    onValueChange={() =>
                      appInvokeRestricted
                        ? setIsAppInvokeRestricted(false)
                        : setIsAppInvokeRestricted(true)
                    }
